...
keys = requests.get('https://raw.githubusercontent.com/alanEG/SecretFinder/master/keys.json').content
dict_str = keys.decode("UTF-8")
_regex = ast.literal_eval(dict_str)
